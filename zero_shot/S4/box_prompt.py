...
if __name__ == "__main__":
    ...
    parser.add_argument("--text_ret_num", default=1, type=int)
    ...
    parser.add_argument('--save_path', default='../../avsbench_data/save_masks/S4_box_prompt', type=str, help="mask save path")
    parser.add_argument('--category_list', default='../../category_list/audioset.json', type=str, help="category list from audioset")
    ...
    with open(args.category_list,'rb') as f:
        categories = json.load(f)
    print("category number:", len(categories))
    ...
    with torch.no_grad():
        ...
        for n_iter, batch_data in enumerate(test_dataloader):
            image_paths, audio, masks, category_list, video_name_list = batch_data
