...
from dataloader import MS3Dataset, MS3Dataset_partial
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log_dir', default='../../avsbench_data/train_logs/ms3_logs', type=str)
    ...
    # Data
    train_dataset = MS3Dataset_partial('train', args.rest_frac)
