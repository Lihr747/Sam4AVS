...
from dataloader import MS3Dataset, MS3Dataset_vggish
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log_dir', default='../../avsbench_data/train_logs/aclp_ms3_vggish_ablation_logs', type=str)
    ...
    # Data
    train_dataset = MS3Dataset_vggish('train')
    ...
    val_dataset = MS3Dataset_vggish('val')
    ...
    test_dataset = MS3Dataset_vggish('test')
