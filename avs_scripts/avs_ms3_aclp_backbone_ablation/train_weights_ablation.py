...
if __name__ == "__main__":
    ...
    parser.add_argument('--log_dir', default='../../avsbench_data/train_logs/aclp_ms3_backbone_ablation_logs', type=str)
    ...
    parser.add_argument('--audioclip_path', default='../../pretrained_backbones/AudioCLIP-Full-Training.pt,../../pretrained_backbones/AudioCLIP-Full-Training.pt')
