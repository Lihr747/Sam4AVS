...
from dataloader import S4Dataset, S4Dataset_partial
...
if __name__ == "__main__":
    ...
    parser.add_argument("--rest_frac", default=0.5, type=float)
    ...
    # Data
    train_dataset = S4Dataset_partial('train', rest_frac=args.rest_frac)
