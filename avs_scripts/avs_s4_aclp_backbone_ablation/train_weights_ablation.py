...
if __name__ == "__main__":
    ...
    parser.add_argument('--log_dir', default='../../avsbench_data/train_logs/aclp_s4_backbone_ablation_logs', type=str)
    ...
    parser.add_argument('--audioclip_path', default='../../pretrained_backbones/AudioCLIP-Full-Training.pt,../../pretrained_backbones/AudioCLIP-Full-Training.pt', type=str, help='path of pretrained audioclip model')
    ...
    for n, p in model.named_parameters():
        ...
        elif 'ESRNXFBSP' in args.audioclip_path and n.startswith('module.aclp.audio.fc'):
            logger.info("add {} to head_model_params_no_norm".format(n))
            head_model_params_no_norm.append(p)
